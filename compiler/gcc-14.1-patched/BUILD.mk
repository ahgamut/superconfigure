o/compiler/gcc-14.1-patched/downloaded:\
	DL_COMMAND = test -d gcc || git clone --depth=1 --branch=portcosmo-14.1 https://github.com/ahgamut/gcc gcc

o/compiler/gcc-14.1-patched/checked: CHECK_COMMAND = $(DUMMYLINK0)
o/compiler/gcc-14.1-patched/patched: PATCH_COMMAND = $(DUMMYLINK0)

o/compiler/gcc-14.1-patched/configured.x86_64: CONFIG_COMMAND = $(DUMMYLINK0)
o/compiler/gcc-14.1-patched/built.x86_64: BUILD_COMMAND = $(DUMMYLINK0)
o/compiler/gcc-14.1-patched/installed.x86_64: INSTALL_COMMAND = $(DUMMYLINK0)

o/compiler/gcc-14.1-patched/configured.aarch64: CONFIG_COMMAND = $(DUMMYLINK0)
o/compiler/gcc-14.1-patched/built.aarch64: BUILD_COMMAND = $(DUMMYLINK0)
o/compiler/gcc-14.1-patched/installed.aarch64: INSTALL_COMMAND = $(DUMMYLINK0)

o/compiler/gcc-14.1-patched/built.fat: FATTEN_COMMAND = $(DUMMYLINK0)
...
o/compiler/x86_64-gcc/built.fat: \
	FATTEN_COMMAND = export TARGET_ARCH=x86_64 && $(BASELOC)/compiler/gcc-14.1-patched/fatten
...
o/compiler/aarch64-gcc/built.fat: \
	FATTEN_COMMAND = export TARGET_ARCH=aarch64 && $(BASELOC)/compiler/gcc-14.1-patched/fatten
