...
o/lib/certs/downloaded: DL_COMMAND = $(DUMMYLINK0)
...
o/lib/certs/built.x86_64: BUILD_COMMAND = $(BASELOC)/lib/certs/certs-to-zip.sh
o/lib/certs/installed.x86_64: INSTALL_COMMAND = $(DUMMYLINK0)

o/lib/certs/configured.aarch64: CONFIG_COMMAND = $(DUMMYLINK0)
o/lib/certs/built.aarch64: BUILD_COMMAND = $(BASELOC)/lib/certs/certs-to-zip.sh
