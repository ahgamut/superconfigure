...
o/$(1)/configured.x86_64: CONFIG_COMMAND = o/$(1)/$(notdir $(1))*/configure $(2)
o/$(1)/configured.aarch64: CONFIG_COMMAND = o/$(1)/$(notdir $(1))*/configure $(3)
endef

define CMAKE_BUILD =
o/$(1)/configured.x86_64: CONFIG_COMMAND = cmake -G Ninja o/$(1)/$(notdir $(1))*/ $(2)
o/$(1)/configured.aarch64: CONFIG_COMMAND = cmake -G Ninja o/$(1)/$(notdir $(1))*/ $(3)
